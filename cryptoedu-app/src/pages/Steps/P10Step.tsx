        ...
        <AccordionDetails>
          <div>
            <ExplanationText>
              ...
              passo anterior duas chaves de 8 bits que serão utilizadas em
          ...
          P10(k_{1}, k_{2}, k_{3}, k_{4}, k_{5}, k_{6}, k_{7},k_{8}, k_{9}, k_{10}) = (k_{3}, k_{5}, k_{2}, k_{7}, k_{4}, k_{10}, k_{1}, k_{9}, k_{8}, k_{6}) */}
            ...
            <ExplanationText>
              ...
              forma: P10 recebe por parâmetro 10 bits K ordenados das posições 1
              à 10 e estes serão então reordenados na seguinte ordem:
            </ExplanationText>
            <BitsField label="P10:" bits={SDES.getP10Positions()} />
            <ExplanationText>
              Lê-se: Na 1ª posição agora ficará o bit que estava na 3ª posição,
              na 2ª posição ficará o bit que estava na 5ª posição, na 3ª posição
              ficará o bit que estava na 2ª posição, e assim consecutivamente...
            </ExplanationText>
            <ExplanationText>
