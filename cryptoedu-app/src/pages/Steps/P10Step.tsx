    ...
    <>
      <StepContentAccordion title="P10 - Permutação de 10 bits">
        <ExplanationText>
          ...
          passo anterior duas chaves de 8 bits (K<sub>1</sub> & K<sub>2</sub>)
          que serão utilizadas em momentos específicos durante o processo de
          criptografia e descriptografia.
        </ExplanationText>
        <ExplanationText>
          O primeiro passo para a obtenção dessas chaves é a permutação da chave
          criptográfica de 10 bits recebida. A permutação ocorrerá através da
          aplicação de uma função de permutação. A função de permutação P10 é
          definida por:
        </ExplanationText>
        ...
        <ExplanationText>
          ...
          seguinte forma: P10 recebe por parâmetro 10 bits K ordenados das
          posições 1 à 10 e estes serão reordenados na seguinte ordem:
        </ExplanationText>
        <BitsField label="P10" bits={SDES.getP10Positions()} />
        <ExplanationText>
          Lê-se: Na 1ª posição ficará o bit que estava na 3ª posição, na 2ª
