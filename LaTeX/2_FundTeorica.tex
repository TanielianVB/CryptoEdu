...
\begin{figure}[H]
    ...
    \legend{Fonte: \textit{https://gchq.github.io/CyberChef/} \cite{gchq20}}
\end{figure}
...
%\begin{itemize}
    %\item Idioma: Inglês.
    %\item Possui vários algoritmos.
    %\item Possui \textit{benchmarking} entre os algoritmos.
    %\item É direcionado ao ensino.
%\end{itemize}
...
%\begin{itemize}
    %\item Idioma: Inglês.
    %\item Possui os algoritmos \textit{simple cipher}, \acrshort{rsa} e \acrshort{sdes}.
    %\item É direcionado ao ensino.
%\end{itemize}
